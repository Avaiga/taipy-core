...
class TestDataManager:
    ...
    def test_ensure_persistence_of_data_node(self):
        ...
        dn_config_1 = Config._add_data_node(id="data node 1", storage_type="in_memory", data="In memory pipeline 2")
        dn_config_2 = Config._add_data_node(id="data node 2", storage_type="in_memory", data="In memory pipeline 2")
