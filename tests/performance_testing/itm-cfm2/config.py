...
group_info = {
    ...
    "EncUP": {"groupe": "EncUP", "anneeHist": 2020, "taux": str([0.0, 0.0, 0.0, 0.0])},
    "DecUP": {"groupe": "DecUP", "anneeHist": 2020, "taux": str([0.0, 0.0, 0.0, 0.0])},
    "EncPet": {"groupe": "EncPet", "anneeHist": 2019, "taux": str([0.0, 0.0, 0.0, 0.0])},
    "DecPet": {"groupe": "DecPet", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "EncRist": {
        "groupe": "EncRist",
        "taux": str([0.0, 0.0, 0.0, 0.0]),
        "anneeHist": 2019,
    ...
    "EncRprox": {"groupe": "EncRprox", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "DecTaxAlc": {"groupe": "DecTaxAlc", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "DecTaxPet": {"groupe": "DecTaxPet", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "DecCouv": {"groupe": "DecCouv", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "DecFgnxHono": {"groupe": "DecFgnxHono", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2019},
    "DecLogStoFac": {"groupe": "DecLogStoFac", "taux": str([0.0, 0.0, 0.0, 0.0]), "anneeHist": 2020},
    "DecImp": {
        "groupe": "DecImp",
        "anneeHist": 2019,
        "taux": str([0.0, 0.0, 0.0, 0.0]),
    ...
    "EncDiversImmo": {
        "groupe": "EncDiversImmo",
        "taux": str([0.0, 0.0, 0.0, 0.0]),
        "anneeHist": 2019,
        "montantAjustement": str([0, 0, 0, 0]),
    },
    "EncIntraGroupe": {
        "groupe": "EncIntraGroupe",
        "taux": str([0.0, 0.0, 0.0, 0.0]),
        "anneeHist": 2019,
        "montantAjustement": str([0, 0, 0, 0]),
    },
